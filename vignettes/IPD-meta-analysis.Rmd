...
To view the JAGS code that was used to run the model, we can run the following command. Note that "alpha" is the study intercept, "beta" is the coefficient for main effects of the covariates, "gamma" is the coefficient for effect modifier, and "d" is the average treatment effect. 
...
```{r}
samples <- ipd.run(ipd, pars.save = c("beta", "gamma", "d"), n.chains = 3, n.burnin = 500, n.iter = 5000)
